export function Footer() {
  const footerLinks = {
    "Обучение": ["Финансовые офферы", "TikTok трафик", "Facebook Ads", "Google UAC", "Арбитраж с нуля", "Масштабирование", "Аналитика ROI"],
    "Курсы": ["Тарифы", "Программа", "Бонусы", "Кейсы учеников", "Сертификат", "FAQ", "Записаться"],
    "Компания": ["О нас", "Наставники", "Отзывы", "Блог", "Партнёрам", "Реквизиты", "Бренд"],
    "Ресурсы": ["Глоссарий арбитража", "Список ПП", "Чек-листы", "Бесплатные уроки", "Конфиденциальность", "Условия", "Оферта"],
    "Связаться": ["Контакты", "Telegram", "ВКонтакте", "YouTube", "TikTok"],
  }
